  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .btn-skip {
      ...
      font-family:'Tajawal',sans-serif; font-size:.95rem; cursor:pointer;
      transition:background .2s,color .2s; letter-spacing:.05em;
    }
    ...
    .title-block h1 {
      font-family:'Playfair Display',serif;
      font-size:clamp(2.2rem,7vw,3.8rem); font-style:italic;
      color:var(--rose-dark); line-height:1.2;
      text-shadow:2px 2px 0 #fff,4px 4px 14px #f4a0b055;
    }
    ...
    .schedule-info {
      background:linear-gradient(135deg,#fde8ed,#fff8f0);
      border:1px solid rgba(212,168,75,.35); border-radius:16px;
    ...
    .section-title {
      ...
      color:var(--rose-dark); letter-spacing:.05em;
    }
    ...
    .tl-item {
      ...
      border-radius:18px; border:1px solid rgba(228,140,160,.2);
    ...
    .tl-time {
      ...
      font-size:.95rem; color:var(--rose-dark); font-weight:700;
      padding-top:.18rem; white-space:nowrap;
    }
    .tl-dot {
      width:10px; height:10px; min-width:10px; background:var(--rose);
      border-radius:50%; margin-top:.46rem; box-shadow:0 0 0 3px rgba(232,99,122,.2);
    }
    .tl-body { flex:1; }
    ...
    .schedule-footer {
      ...
      background:linear-gradient(135deg,#e8637a22,#d4a84b22);
      border-radius:14px; padding:.9rem 1rem;
      font-size:.88rem; color:var(--ink); line-height:1.8;
    }
    ...
    input[type="text"],textarea {
      width:100%; background:rgba(255,248,240,.9);
      border:1.5px solid rgba(228,140,160,.5); border-radius:14px;
      padding:.75rem 1.1rem; font-family:'Tajawal',sans-serif;
    ...
    input[type="text"]:focus,textarea:focus {
      ...
      box-shadow:0 0 0 3px rgba(232,99,122,.15);
    }
    ...
    .btn-send {
      ...
      font-family:'Tajawal',sans-serif; font-size:1.1rem; font-weight:500;
      cursor:pointer; letter-spacing:.06em;
      box-shadow:0 4px 18px rgba(192,64,90,.35);
    ...
    .success-msg {
      display:none; text-align:center; padding:1.6rem 1rem;
...
<div class="page" id="mainPage">
  ...
  <div class="card schedule-card">
    ...
    <div class="timeline">
      <div class="tl-item">
        <div class="tl-time">٧:٠٠</div>
        <div class="tl-dot"></div>
        <div class="tl-body">
          <strong>🪅 فقرة الـ Welcome &amp; QR Wishes</strong>
          <p>حنستقبلكم بالضحكة واللعب، وحتلاقوا QR Code مستنيكم عشان تكتبوا أول أمنية لـ روز 💌📱</p>
        </div>
      </div>
      <div class="tl-item">
        <div class="tl-time">٧:٣٠</div>
        <div class="tl-dot"></div>
        <div class="tl-body">
          <strong>📸 فقرة التصوير — Photo Session</strong>
          <p>حنتصور سوا في كورنر الديكور ونوثق أجمل اللحظات مع روز وهي منورة سنة أولى 👗✨</p>
        </div>
      </div>
      <div class="tl-item">
        <div class="tl-time">٧:٤٥</div>
        <div class="tl-dot"></div>
        <div class="tl-body">
          <strong>🎨 فقرة المبدعين الصغيرين — Art &amp; Colors</strong>
          <p>معانا أشكال جبس جاهزة ومستنية ألوانكم! حنلون ونبدع بالصلصال ونعمل أحلى "تحف فنية" 🖌️🗿</p>
        </div>
      </div>
      <div class="tl-item">
        <div class="tl-time">٨:١٥</div>
        <div class="tl-dot"></div>
        <div class="tl-body">
          <strong>🎂 فقرة التورتة والـ Cake Smash</strong>
          <p>أهم لحظة في اليوم! حنطفي الشمعة الأولى ونشوف بهدلة الكيكة اللذيذة 🎂🥳</p>
        </div>
      </div>
      <div class="tl-item">
        <div class="tl-time">٨:٤٥</div>
        <div class="tl-dot"></div>
        <div class="tl-body">
          <strong>💃🏻 فقرة الـ Baby Disco</strong>
          <p>أغاني الأطفال اللي بنحبها، حنرقص ونملا البيت بهجة وسعادة 🎶👶🏻🪩</p>
        </div>
      </div>
    </div>
...
/* Countdown */
const TARGET=new Date('2026-04-17T19:00:00');
function updateCd(){
...
function skipCountdown(){document.getElementById('countdown-screen').classList.add('gone');}
</script>
...
async function sendWish(){
  ...
  try{
    ...
    if(r.ok){
      const d=await r.json();
      if(d.success){success=true; count=d.count;}
    }
  }catch(e){
    /* no PHP server – simulate for demo */
